                ...
                <div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-custombutton="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <form action="{{ route('admin.categories.store') }}" method="POST" class="smart-form" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-xs-12">
                                <section class="col col-6">
                                    ...
                                    <img src="" alt="icon" width="15px" height="15px" id="iconElement">
                                    <span style="color: red">{{ $errors->category->first('icon') }}</span>
                                </section>
                                <div class="col col-6">
                                    <label for="images" class="input">{{ __('Նկար') }}</label>
                                    <input type="file" id="images_input" name="images" value="{{ old('images') }}">
